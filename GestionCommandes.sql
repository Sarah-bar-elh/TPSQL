...
--
-- Serveur: 127.0.0.1
-- Généré le : Jeu 19 Décembre 2024 à 09:57
...
INSERT INTO `clients` (`id_client`, `nom`, `prenom`, `email`, `date`) VALUES
(1, 'Dupont', 'Marie', 'marie.dupont@example', '2023-01-10'),
(2, 'Durand', 'Paul', 'paul.durand@example.', '2023-02-20'),
(7, 'Martin ', 'Alice', 'alice.martin@example', '2023-03-15');
...
INSERT INTO `commandes` (`id_commande`, `id_client`, `datecommande`, `montanttotal`) VALUES
...
INSERT INTO `produit` (`id_produit`, `nomproduit`, `prix`, `stock`) VALUES
...
ALTER TABLE `detailscommandes`
  ADD CONSTRAINT `detailscommandes_ibfk_2` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON DELETE CASCADE ON UPDATE CASCADE,
